  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#eef3e8] via-[#f8faf6] to-[#dce6d2] flex items-center justify-center p-4">
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-2xl overflow-hidden border border-[#d5decb] grid grid-cols-1 md:grid-cols-2">
        <div className="hidden md:flex flex-col justify-between p-10 bg-gradient-to-br from-[#4f5f4c] to-[#7f907b] text-white">
          <div>
            <p className="text-sm tracking-[0.2em] uppercase text-[#eaf0e4]">
              PetCare
            </p>
            <h2 className="text-4xl mt-5 leading-tight">
              Welcome back to your pet household.
            </h2>
          </div>
          <p className="text-sm text-[#eaf0e4]">
            Track tasks, appointments, and updates all in one place.
          </p>
        </div>

        <div className="p-8 md:p-10">
          <h1 className="text-3xl text-[#4f5a4c] mb-2">Welcome Back</h1>
          <p className="text-sm text-[#70806c] mb-6">
            Log in to continue managing your pets.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 rounded-lg bg-[#4f5f4c] text-white hover:bg-[#404f3d] transition disabled:opacity-70"
            >
          ...
          <p className="text-sm text-center mt-6 text-[#6f7f6c]">
            ...
            <Link href="/signup" className="text-[#4e614b] underline">
              Sign up
            </Link>
          </p>
        </div>
